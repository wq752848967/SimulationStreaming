...
public class FlokSimStreamTest {
    ...
    //private static String jarPath-server  = "file:///tmp/spark-warehouse/user_defined/algorithm/workflow-0.1.0-SNAPSHOT-jar-with-dependencies.jar";
    private static int threadNum = 5;
    public static void main(String[] args) {
        long start = System.currentTimeMillis();
        SparkSession session = SparkSession.builder().master(masterUrl).getOrCreate();
        SparkStreamSchedular streamShcedular = new SparkStreamSchedular(session,jarPath,definition,4);
